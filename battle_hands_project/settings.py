"""
Django settings for battle_hands_project project.
...
WSGI_APPLICATION = 'battle_hands_project.wsgi.application'
...
ASGI_APPLICATION = "battle_hands_project.asgi.application"
